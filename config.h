...
#if BAR_PANGO_PATCH
static const char font[]                 = "JetBrains Mono Nerd Font 10";
#else
...
static char *tagicons[][NUMTAGS] = {
	[DEFAULT_TAGS]        = { "DEV", "WWW", "3", "4", "5", "6", "7", "8", "MSC" },
	[ALTERNATIVE_TAGS]    = { "A", "B", "C", "D", "E", "F", "G", "H", "I" },
	[ALT_TAGS_DECORATION] = { "<1>", "<2>", "<3>", "<4>", "<5>", "<6>", "<7>", "<8>", "<9>" },
};

static const char *tags[] = { "DEV", "WWW", "3", "4", "5", "6", "7", "8", "9" };
...
/* static const char *spotifycmd[] = {"LD_PRELOAD=/home/wanty/src/clones/spotifywm/spotifywm.so", "spotify", NULL }; */
